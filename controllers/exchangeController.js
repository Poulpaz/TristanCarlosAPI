...
exports.addNewExchange = function (req, res, next) {
    ...
    connectionOnline.query("INSERT INTO exchange (idUser, idOtherUser, cardUser, cardOtherUser, validUser, validOtherUser) VALUES ('" + idUser + "', '" + idOtherUser + "', '" + cardUser + "', '" + cardOtherUser + "', '" + validUser + "', '" + validOtherUser + "') WHERE NOT EXISTS(SELECT * FROM exchange)", function (err, result, fields) {
        if (err) { throw err; }
