...
exports.addNewExchange = function (req, res, next) {
    ...
    connectionOnline.query("INSERT INTO exchange (idUser, idOtherUser, cardUser, cardOtherUser, validUser, validOtherUser, validUser, validOtherUser) VALUES ('" + idUser + "', '" + idOtherUser + "', '" + cardUser + "', '" + cardOtherUser + "', '" + validUser + "', '" + validOtherUser + "')", function (err, result, fields) {
        if (err) { throw err; }
